...
create table customer(document varchar(20), number varchar(30), name varchar(20), gender varchar(15), country varchar(20), room varchar(10), checkintime varchar(80));
select * from customer;

create table department(department varchar(30), budget varchar(30));
insert into department values ('Front Office','10000');
insert into department values ('Housekeeping','50000');
insert into department values ('Food and Beverage','30000');
insert into department values ('Kitchen or Food Production','40000');
insert into department values ('Security','10000');
